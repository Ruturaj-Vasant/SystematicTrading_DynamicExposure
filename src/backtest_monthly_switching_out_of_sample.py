...
# === Config ===
PREDICTION_FILE = "results/predicted_best_strategy_out_of_sample.csv"
RETURN_FILE = "results/spy_vix_strategy_returns_out_of_sample.csv"
OUTPUT_FILE = "results/monthly_strategy_switch_returns_out_of_sample.csv"
...
df_result.to_csv("results/monthly_strategy_switch_equity_curve_out_of_sample.csv")
