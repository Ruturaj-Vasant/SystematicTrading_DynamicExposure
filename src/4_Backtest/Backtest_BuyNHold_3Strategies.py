...
#     # Strategy 4: Buy & Hold
#     df['Returns_BuyHold'] = df['Return']

#     return df

# def evaluate(df):
#     strategies = ['Returns_Baseline', 'Returns_Conservative', 'Returns_TCVS', 'Returns_BuyHold']
#     results = {}
...
#     (1 + df['Returns_BuyHold'].fillna(0)).cumprod().plot(label='Buy & Hold', linestyle='--', linewidth=2)
#     plt.title('Cumulative Returns: Strategy Comparison vs Buy & Hold')
#     plt.xlabel('Date')
