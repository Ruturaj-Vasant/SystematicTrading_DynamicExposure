...
# def download_data(start='2024-04-20', end='2025-05-10'):
def download_data(start='1950-01-01', end='2025-05-10'):
    ...
    data.to_csv('data/spy_vix_data_Long.csv')
    print("✅ Data downloaded and saved to /data/spy_vix_data_Long.csv")
